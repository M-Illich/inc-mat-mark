...
public class UpdateStreamRunTest {
	...
	@Test
	public void testCreateBracketString() {
		LinkedHashSet<Fact> facts = new LinkedHashSet<>();
		facts.add(f1);
		facts.add(f2);
		
		String s = usr.createBracketString(facts);
		assertEquals("[[nextInWay, 1, 2, 1], [nextInWay, 2, 3, 2]]", s);
	}
