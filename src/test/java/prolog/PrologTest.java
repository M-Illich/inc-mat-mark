...
public class PrologTest {
	...
	public void testProlog() {
		...
		testProlog("dred/dred_ways_no_mark.pl", "dred/dred_ways_mark.pl", "materialize_ways.pl");
		System.out.println("--------");
		System.out.println("");
		System.out.println("Ways test - B/F");
		testProlog("bf/bf_ways_no_mark.pl", "bf/bf_ways_mark.pl", "materialize_ways.pl");

	}

	private void testProlog(String file1, String file2, String fileExpected) {

		System.out.println("");

		String updateFolder = "src/test/resources/updates"; 	// "src/main/resources/updates/ways/updates_track1";
		int numberOfUpdates = 5;	// 83;
