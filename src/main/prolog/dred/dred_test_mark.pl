...
phase(1), fact([nextInWay, X, _, Z1],O1,M1,_), fact([nextInWay, X, _, Z2],O2,M2,_) \ fact([connection, Z1, Z2],add,_,U) <=> Z1 \== Z2, member(del,[O1,O2]) | check_pos_mark([(nextInWay,O1,M1),(nextInWay,O2,M2)],M), fact([connection, Z1, Z2],del,M,U), applied_rules(1,del).
phase(1), fact([nextInWay, X, _, Z1],O1,M1,_), fact([nextInWay, _, X, Z2],O2,M2,_) \ fact([connection, Z1, Z2],add,_,U) <=> Z1 \== Z2, member(del,[O1,O2]) | check_pos_mark([(nextInWay,O1,M1),(nextInWay,O2,M2)],M), fact([connection, Z1, Z2],del,M,U), applied_rules(1,del).
phase(1), fact([nextInWay, _, X, Z1],O1,M1,_), fact([nextInWay, X, _, Z2],O2,M2,_) \ fact([connection, Z1, Z2],add,_,U) <=> Z1 \== Z2, member(del,[O1,O2]) | check_pos_mark([(nextInWay,O1,M1),(nextInWay,O2,M2)],M), fact([connection, Z1, Z2],del,M,U), applied_rules(1,del).
phase(1), fact([nextInWay, _, X, Z1],O1,M1,_), fact([nextInWay, _, X, Z2],O2,M2,_) \ fact([connection, Z1, Z2],add,_,U) <=> Z1 \== Z2, member(del,[O1,O2]) | check_pos_mark([(nextInWay,O1,M1),(nextInWay,O2,M2)],M), fact([connection, Z1, Z2],del,M,U), applied_rules(1,del).
...
phase(2), fact([nextInWay, X, _, Z1],add,M1,_), fact([nextInWay, X, _, Z2],add,M2,_) \ fact([connection, Z1, Z2],del,_,U) <=> Z1 \== Z2, true | check_neg_mark([M1,M2],M), fact([connection, Z1, Z2],add,M,U), applied_rules(1,red).
phase(2), fact([nextInWay, X, _, Z1],add,M1,_), fact([nextInWay, _, X, Z2],add,M2,_) \ fact([connection, Z1, Z2],del,_,U) <=> Z1 \== Z2, true | check_neg_mark([M1,M2],M), fact([connection, Z1, Z2],add,M,U), applied_rules(1,red).
phase(2), fact([nextInWay, _, X, Z1],add,M1,_), fact([nextInWay, X, _, Z2],add,M2,_) \ fact([connection, Z1, Z2],del,_,U) <=> Z1 \== Z2, true | check_neg_mark([M1,M2],M), fact([connection, Z1, Z2],add,M,U), applied_rules(1,red).
phase(2), fact([nextInWay, _, X, Z1],add,M1,_), fact([nextInWay, _, X, Z2],add,M2,_) \ fact([connection, Z1, Z2],del,_,U) <=> Z1 \== Z2, true | check_neg_mark([M1,M2],M), fact([connection, Z1, Z2],add,M,U), applied_rules(1,red).
...
phase(4), fact([nextInWay, X, _, Z1],add,M1,U1), fact([nextInWay, X, _, Z2],add,M2,U2) ==> Z1 \== Z2, member(U,[U1,U2]) | check_neg_mark([M1,M2],M), fact([connection, Z1, Z2],add,M,U), applied_rules(1,ins).
phase(4), fact([nextInWay, X, _, Z1],add,M1,U1), fact([nextInWay, _, X, Z2],add,M2,U2) ==> Z1 \== Z2, member(U,[U1,U2]) | check_neg_mark([M1,M2],M), fact([connection, Z1, Z2],add,M,U), applied_rules(1,ins).
phase(4), fact([nextInWay, _, X, Z1],add,M1,U1), fact([nextInWay, X, _, Z2],add,M2,U2) ==> Z1 \== Z2, member(U,[U1,U2]) | check_neg_mark([M1,M2],M), fact([connection, Z1, Z2],add,M,U), applied_rules(1,ins).
phase(4), fact([nextInWay, _, X, Z1],add,M1,U1), fact([nextInWay, _, X, Z2],add,M2,U2) ==> Z1 \== Z2, member(U,[U1,U2]) | check_neg_mark([M1,M2],M), fact([connection, Z1, Z2],add,M,U), applied_rules(1,ins).
phase(4), fact([connection, X, Y],add,M1,U1), fact([connection, Y, Z],add,M2,U2) ==> X \== Y, member(U,[U1,U2]) | check_neg_mark([M1,M2],M), fact([connection, X, Z],add,M,U), applied_rules(1,ins).
