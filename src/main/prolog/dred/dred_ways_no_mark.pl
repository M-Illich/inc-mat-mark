...
phase(1), fact([nextInWay, X1, Y1, Z1],O1,_), fact([nextInWay, X2, Y2, Z2],O2,_) \ fact([connection, Z1, Z2],add,U) <=> Z1 \== Z2, (X1 == X2 ; X1 == Y2 ; Y1 == X2 ; Y1 == Y2), member(del,[O1,O2]) | fact([connection, Z1, Z2],del,U), applied_rules(1,del).
...
phase(2), fact([nextInWay, X1, Y1, Z1],add,_), fact([nextInWay, X2, Y2, Z2],add,_) \ fact([connection, Z1, Z2],del,U) <=> Z1 \== Z2, (X1 == X2 ; X1 == Y2 ; Y1 == X2 ; Y1 == Y2), true | fact([connection, Z1, Z2],add,U), applied_rules(1,red).
