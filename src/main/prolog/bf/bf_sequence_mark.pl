...
phase(1), fact([edge, X, Y],O1,_,_) \ fact([edge1, X, Y],add,_,U) <=> member(del,[O1]) | fact([edge1, X, Y],chk,_,U), applied_rules(1,del).
phase(1), fact([edge1, X, Y],O1,_,_) \ fact([edge2, X, Y],add,_,U) <=> member(del,[O1]) | fact([edge2, X, Y],chk,_,U), applied_rules(1,del).
phase(1), fact([edge2, X, Y],O1,_,_) \ fact([edge3, X, Y],add,_,U) <=> member(del,[O1]) | fact([edge3, X, Y],chk,_,U), applied_rules(1,del).
phase(1), fact([edge3, X, Y],O1,_,_) \ fact([edge4, X, Y],add,_,U) <=> member(del,[O1]) | fact([edge4, X, Y],chk,_,U), applied_rules(1,del).
...
% - forward -
fact([edge, X, Y],prv,M1,_) \ fact([edge1, X, Y],O,_,U) <=> member(O,[chk,chk1]) | fact([edge1, X, Y],prv,M1,U), applied_rules(1,fwd).
fact([edge1, X, Y],prv,_,_) \ fact([edge2, X, Y],O,_,U) <=> member(O,[chk,chk1]) | fact([edge2, X, Y],prv,_,U), applied_rules(1,fwd).
fact([edge2, X, Y],prv,_,_) \ fact([edge3, X, Y],O,_,U) <=> member(O,[chk,chk1]) | fact([edge3, X, Y],prv,_,U), applied_rules(1,fwd).
fact([edge3, X, Y],prv,_,_) \ fact([edge4, X, Y],O,_,U) <=> member(O,[chk,chk1]) | fact([edge4, X, Y],prv,_,U), applied_rules(1,fwd).


% - backward -
fact([edge1, X, Y],chk1,_,_), fact([edge, X, Y],O1,M1,U1) ==> \+member(del,[O1]) | fact([edge, X, Y],chk1,M1,U1), applied_rules(1,bwd).
fact([edge2, X, Y],chk1,_,_), fact([edge1, X, Y],O1,M1,U1) ==> \+member(del,[O1]) | fact([edge1, X, Y],chk1,M1,U1), applied_rules(1,bwd).
fact([edge3, X, Y],chk1,_,_), fact([edge2, X, Y],O1,M1,U1) ==> \+member(del,[O1]) | fact([edge2, X, Y],chk1,M1,U1), applied_rules(1,bwd).
fact([edge4, X, Y],chk1,_,_), fact([edge3, X, Y],O1,M1,U1) ==> \+member(del,[O1]) | fact([edge3, X, Y],chk1,M1,U1), applied_rules(1,bwd).
