...
phase(1), fact([e, X, Y],O1,_) \ fact([p, X, Y],add,U) <=> member(del,[O1]) | fact([p, X, Y],chk,U), applied_rules(1,del).
phase(1), fact([e, X, Y],O1,_), fact([p, Y, Z],O2,_) \ fact([p, X, Z],add,U) <=> member(del,[O1,O2]) | fact([p, X, Z],chk,U), applied_rules(1,del).
...
% - forward -
fact([e, X, Y],prv,_) \ fact([p, X, Y],O,U) <=> member(O,[chk,chk1]) | fact([p, X, Y],prv,U), applied_rules(1,fwd).
fact([e, X, Y],prv,_), fact([p, Y, Z],prv,_) \ fact([p, X, Z],O,U) <=> member(O,[chk,chk1]) | fact([p, X, Z],prv,U), applied_rules(1,fwd).


% - backward -
fact([p, X, Y],chk1,_), fact([e, X, Y],O1,U1) ==> \+member(del,[O1]) | fact([e, X, Y],chk1,U1), applied_rules(1,bwd).
fact([p, X, Z],chk1,_), fact([e, X, Y],O1,U1), fact([p, Y, Z],O2,U2) ==> \+member(del,[O1,O2]) | fact([e, X, Y],chk1,U1), fact([p, Y, Z],chk1,U2), applied_rules(1,bwd).
