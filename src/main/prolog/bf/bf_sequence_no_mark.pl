...
phase(1), fact([edge, X, Y],O1,_) \ fact([edge1, X, Y],add,U) <=> member(del,[O1]) | fact([edge1, X, Y],chk,U), applied_rules(1,del).
phase(1), fact([edge1, X, Y],O1,_) \ fact([edge2, X, Y],add,U) <=> member(del,[O1]) | fact([edge2, X, Y],chk,U), applied_rules(1,del).
phase(1), fact([edge2, X, Y],O1,_) \ fact([edge3, X, Y],add,U) <=> member(del,[O1]) | fact([edge3, X, Y],chk,U), applied_rules(1,del).
phase(1), fact([edge3, X, Y],O1,_) \ fact([edge4, X, Y],add,U) <=> member(del,[O1]) | fact([edge4, X, Y],chk,U), applied_rules(1,del).
...
% - forward -
fact([edge, X, Y],prv,_) \ fact([edge1, X, Y],O,U) <=> member(O,[chk,chk1]) | fact([edge1, X, Y],prv,U), applied_rules(1,fwd).
fact([edge1, X, Y],prv,_) \ fact([edge2, X, Y],O,U) <=> member(O,[chk,chk1]) | fact([edge2, X, Y],prv,U), applied_rules(1,fwd).
fact([edge2, X, Y],prv,_) \ fact([edge3, X, Y],O,U) <=> member(O,[chk,chk1]) | fact([edge3, X, Y],prv,U), applied_rules(1,fwd).
fact([edge3, X, Y],prv,_) \ fact([edge4, X, Y],O,U) <=> member(O,[chk,chk1]) | fact([edge4, X, Y],prv,U), applied_rules(1,fwd).


% - backward -
fact([edge1, X, Y],chk1,_), fact([edge, X, Y],O1,U1) ==> \+member(del,[O1]) | fact([edge, X, Y],chk1,U1), applied_rules(1,bwd).
fact([edge2, X, Y],chk1,_), fact([edge1, X, Y],O1,U1) ==> \+member(del,[O1]) | fact([edge1, X, Y],chk1,U1), applied_rules(1,bwd).
fact([edge3, X, Y],chk1,_), fact([edge2, X, Y],O1,U1) ==> \+member(del,[O1]) | fact([edge2, X, Y],chk1,U1), applied_rules(1,bwd).
fact([edge4, X, Y],chk1,_), fact([edge3, X, Y],O1,U1) ==> \+member(del,[O1]) | fact([edge3, X, Y],chk1,U1), applied_rules(1,bwd).
...
phase(5), fact([edge, X, Y],add,U1) ==> member(U,[U1]) | fact([edge1, X, Y],add,U), applied_rules(1,ins).
phase(5), fact([edge1, X, Y],add,U1) ==> member(U,[U1]) | fact([edge2, X, Y],add,U), applied_rules(1,ins).
phase(5), fact([edge2, X, Y],add,U1) ==> member(U,[U1]) | fact([edge3, X, Y],add,U), applied_rules(1,ins).
phase(5), fact([edge3, X, Y],add,U1) ==> member(U,[U1]) | fact([edge4, X, Y],add,U), applied_rules(1,ins).
